...
module.exports = app => {
    ...
    const save = async (req, res) => {
        ...
        try {
            ...
            existsOrError(user.especiality, 'Especialidade não informada')
    ...
    const get = (req, res) => {
        app.db('users')
            .select('id', 'name', 'email', 'cpf', 'especiality')
            .whereNull('deletedAt')
    ...
    const remove = async (req, res) => {
        try {
            existsOrError(req.params.id, 'Código do medico não informado.')
